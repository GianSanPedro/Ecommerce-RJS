  ...
  useEffect(() => {
    ...
    async function validar() {
      ...
      if (token) {
        ...
        console.log("Respuesta de validacion de token:", rta);
  ...
  return (
    <div className="App">
      <header>
            ...
            <div id="container-carrito">
              {!esAdmin && (
                <button id="boton-carrito" onClick={handleShowCarrito}>
                  <img
                    src="/ICON/Cart_bask_shop_icon.png"
              ...
              {!login || usuario.nombre === "Visitante" ? (
                <button id="boton-login" onClick={handleShowLogin}>
                  <img
                    src="/ICON/Account_circle_icon.png"
                    alt="Icono usuario"
                  />
                </button>
              ) : (
                <button id="boton-logout" onClick={logout}>
                  <img
                    src="/ICON/Account_circle_active_icon.png"
                    alt="Icono usuario"
                  />
        ...
        {!esAdmin && <ModalCarrito show={showCarrito} handleClose={handleCloseCarrito} />}
        <ModalLogin
          show={showLogin}
      ...
      <main>
        <Routes>
          <Route index element={<Inicio filtro={filtro} esAdmin={esAdmin} />} />
          <Route path="inicio" element={<Inicio filtro={filtro} esAdmin={esAdmin} />} />
          <Route path="alta" element={<Alta />} />
          <Route path="carrito" element={<Carrito />} />
          <Route path="contacto" element={<Contacto />} />
          <Route path="nosotros" element={<Nosotros />} />
          <Route path="chat" element={<Chat />} />
          <Route path="*" element={<Inicio filtro={filtro} esAdmin={esAdmin} />} />
        </Routes>
      </main>
